...
// Sales contact values are kept module-private and only flow into href
// attributes — never rendered as visible text or aria-labels. Visible UI
// uses generic feature names ("Chat on WhatsApp", "Email sales").
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
        {/*
          Visible labels intentionally generic — phone/email values are not
          rendered as text. The actual address is only carried in the link
          href (required for tel:/wa.me/mailto: to function), so they don't
          appear in scrape-friendly visible content or on screenshots.
        */}
        <a
          href={waLink}
          target="_blank"
