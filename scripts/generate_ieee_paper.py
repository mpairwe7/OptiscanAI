...
def add_results(doc):
    ...
    _add_para(doc, "Classification Performance: V1 Baseline vs. V2 Precision Rescue", "Table Title")
...
def add_references(doc):
    ...
    refs = [
        ...
        # [35]
        'Iterative, "DVC: Data Version Control," 2024. [Online]. Available: ' "https://dvc.org",
        # [36]
...
def main():
    ...
    print(
        f"  Index terms preserved: {'Retinal Disease Screening' in verify_doc.paragraphs[12].text}"
    )
