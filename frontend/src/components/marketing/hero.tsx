        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-16 items-center">
          <div className="max-w-xl">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                href="/sign-up"
                className="group inline-flex items-center gap-1.5 rounded-full bg-slate-900 hover:bg-slate-800 min-h-[48px] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 transition-all hover:-translate-y-px"
              >
                Try free
                <svg
              ...
              <Link
                href="/pricing"
                className="inline-flex items-center rounded-full border border-slate-300 bg-white min-h-[48px] px-6 py-3 text-sm font-semibold text-slate-900 hover:border-slate-400 hover:bg-slate-50"
              >
                See pricing
              </Link>
            </div>

            <ul className="mt-6 flex flex-wrap gap-x-5 gap-y-2 text-xs text-slate-600">
              <li className="inline-flex items-center gap-1.5">
                <svg className="w-3.5 h-3.5 text-teal-700 font-bold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3} aria-hidden>
          ...
          <div className="relative">
            ...
            >
              ...
              />
              <div className="aspect-[4/3] min-h-[220px] rounded-2xl overflow-hidden ring-1 ring-slate-900/5 bg-gradient-to-br from-white via-teal-50/50 to-cyan-50/50 flex items-center justify-center">
                <Image
                  src="/logo.png"
                  alt="OptiscanAI"
                  width={360}
              ...
              <div className="mt-3 grid grid-cols-3 gap-2 rounded-2xl bg-white/80 backdrop-blur border border-slate-200/70 p-3">
                <div className="text-center">
                  <div className="text-[10px] uppercase tracking-wider font-semibold text-slate-600">Diseases</div>
                ...
                <div className="text-center border-x border-slate-200/70">
                  <div className="text-[10px] uppercase tracking-wider font-semibold text-slate-600">Inference</div>
                  <div className="mt-0.5 font-mono text-lg font-bold text-slate-900">
                    85<span className="text-xs text-slate-600 ml-0.5 font-sans">ms</span>
                  </div>
                </div>
                <div className="text-center">
                  <div className="text-[10px] uppercase tracking-wider font-semibold text-slate-600">AUC</div>
