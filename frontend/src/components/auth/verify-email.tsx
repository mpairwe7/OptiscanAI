...
export function VerifyEmail() {
  ...
  return (
    <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 text-center">
      ...
      {state === "ok" && (
        <>
          <div className="w-10 h-10 mx-auto rounded-full bg-teal-50 text-teal-700 font-bold flex items-center justify-center">✓</div>
          <h1 className="mt-4 font-semibold text-slate-900">Email verified</h1>
          <Link
            href="/app/dashboard"
            className="mt-4 inline-flex items-center justify-center min-h-[44px] px-4 py-2 text-sm font-semibold rounded-lg bg-teal-700 hover:bg-teal-800 text-white transition-colors shadow-sm"
          >
